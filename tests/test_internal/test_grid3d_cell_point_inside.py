...
def test_tricky_drogon_cell():
    """Test a tricky cell with a point inside, cf testdata ...drogon//1/geogrid.roff."""
    cell_110_171_81 = [
        465036.450,
        5931366.81,
        1673.49710,
    ...
    cr1 = _internal.grid3d.CellCorners(cell_110_171_81)
    cr2 = _internal.grid3d.CellCorners(cell_110_172_81)
    cr3 = _internal.grid3d.CellCorners(cell_110_171_one)
