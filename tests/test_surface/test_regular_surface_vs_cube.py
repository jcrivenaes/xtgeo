...
def test_slice_trilinear_snapxy(tmpdir, load_cube_rsgy1, generate_plot):
...
def test_slice_nearest_nosnapxy(tmpdir, load_cube_rsgy1, generate_plot):
...
def test_slice_trilinear_nosnapxy(tmpdir, load_cube_rsgy1, generate_plot):
    """Slice a cube with a surface, nearest node, algorithm 1 + 2, other map layout"""
...
def test_slice_nearest(tmpdir, load_cube_rsgy1, generate_plot):
...
def test_slice_nearest_v2(tmpdir, load_cube_rsgy1, generate_plot):
...
def test_slice_various_reek(tmpdir, load_cube_rsgy1, generate_plot):
...
def test_slice_attr_window_max_w_plotting(tmpdir, load_cube_rsgy1, generate_plot):
...
def test_cube_attr_rms_two_surfaces_compare_window_show(
    tmpdir, load_cube_rsgy1, generate_plot
):
    """Get cube attribute (rms) between two surfaces, and compare with
...
def test_cube_slice_w_dead_traces_nearest(tmpdir, generate_plot):
    """Get cube slice nearest aka Auto4D input, with scrambled data with
...
def test_cube_slice_w_dead_traces_trilinear(tmpdir, generate_plot):
    """Get cube slice trilinear aka Auto4D input, with scrambled data with
    dead traces to be ignored, various YFLIP cases."""
