...
def test_get_ijk_from_points_small(smallgrid):
    ...
    ijk = smallgrid.get_ijk_from_points(po)

    assert ijk["JY"][0] == 2
    assert ijk["JY"][1] == -1

    # activeonly False
    ijk = smallgrid.get_ijk_from_points(po, activeonly=False)
    assert ijk["JY"][1] == 3
