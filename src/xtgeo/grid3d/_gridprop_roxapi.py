...
if TYPE_CHECKING:
    ...
    if roxar is not None:
        from roxar.api.project import Project as Roxar_Project  # type: ignore[import]  # noqa
        from roxar.grids import Grid3D as Roxar_Grid3D
...
def _store_in_roxar(
    ...
    assert roxar is not None
    roxar_property_type = (
        roxar.GridPropertyType.discrete  # noqa  # type: ignore
        if self.isdiscrete  # noqa  # type: ignore
        else roxar.GridPropertyType.continuous  # noqa  # type: ignore
    )
