...
and it is targeted to Equinor usage using bash or tchs shell in Linux:

```sh
# estabslish and activate RMS python in a virtual environment, e.g. RMS version 14.2.2
